...
from blog.views import Cliente, ClienteCreate, ClienteDelete, ClienteDetail, ClienteList, EditaElimina, EditarDatos, LoginView, Quienes_Somos, agregar_avatar, cliente, editar_perfil, editarCliente, eliminarCliente, lista_clientes, mecanico, BusquedaCliente, ClienteFormulario, mecanicoFormulario, register, reparacion, inicio, Buscar
